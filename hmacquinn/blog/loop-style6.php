...
<article id="post-<?php the_ID(); ?>" class="element not-wide blog-post clearfix <?php echo esc_attr( $post_classes ); ?>" <?php echo esc_attr( $article_gutter ); ?>>
	<div class="element-inner" style="<?php echo ($blog_attr['style'] == 'style3') ? 'margin-left:'.$blog_attr['gutter_width'].'px' : ''; ?>">
		<div class="post-content-wrap">
			<?php
				/* if( $post_format != 'quote' && $post_format != 'link' ) { // thumbnail.
			...
			<div class="article-details clearfix">
				...
				<?php if( $post_format != 'quote' && $post_format != 'link' ):
					echo '<div class="tatsu-column  tatsu-one-third reach-pull-right">';
						get_template_part( 'content', $post_format );/* zig move to here */
					echo "</div>";
					echo '<div class ="tatsu-column tatsu-two-third">';
					 ?>
	...
	<?php if(is_single()) { ?>
		<?php /* zig xount <div class="clearfix single-post-share single-page-atts">
